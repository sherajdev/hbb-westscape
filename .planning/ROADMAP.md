...
Plans:
- [x] 01-01-PLAN.md — Project scaffolding with Convex + Clerk template, environment setup, auth verification
- [x] 01-02-PLAN.md — Database schema for users/businesses, user creation on auth, one-per-user constraint
